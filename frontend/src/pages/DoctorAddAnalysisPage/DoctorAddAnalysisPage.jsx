...
import { getPatientById } from '../../features/patients/api/patientsApi'
import { useToast } from '../../shared/hooks/useToast'
import ToastContainer from '../../shared/ui/Toast/ToastContainer'
import styles from './DoctorAddAnalysisPage.module.css'


export default function DoctorAddAnalysisPage() {
  ...
  const loadPatientData = async () => {
    try {
      ...
      showToast('Ошибка загрузки данных пациента', '#e0745f')
    }
  }
  ...
  const handleAnalyze = async () => {
    ...
    setLoading(true)
    try {
      const uploadResult = await uploadSkinImage(selectedImage, id)
      setUploadedImageId(uploadResult.id)
      
      const predictionResult = await createPrediction(id, uploadResult.id)
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.content}>
        <PageHeader 
          title={patient ? `Новый анализ для: ${patient.fullname}` : "Новый анализ"}
            ...
            <div className={styles.resultsPanel}>
              {loading ? (
                ...
                <>
                  ...
                  <button onClick={handleReset} className={styles.newAnalysisBtnCustom}>
